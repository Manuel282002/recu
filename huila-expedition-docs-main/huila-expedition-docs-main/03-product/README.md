...
# Product Roadmap — Huila Travel Expedition
...
* Registration, publication, and management of tour packages.
* Tour package browsing/inquiry.
* Offer search.
* Filters by municipality, price, and duration.
* Display of package details.
* Image uploading and package categorization.

The goal of this phase is to build the core functionality for centralizing, browsing, and comparing tourism offerings.

## Phase 2 — Iteration

### Sprints 4–6

* Availability management via calendar.
* Booking requests.
* Booking approval and cancellation by agencies.
* Booking history.
* Ratings and reviews.
...
These functionalities correspond to the features outlined in the SRS functional requirements.
